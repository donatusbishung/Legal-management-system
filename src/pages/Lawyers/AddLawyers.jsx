    ...
    <div className="dashboard w-full flex h-screen">
      ...
      <div className="main-content w-full " style={{ height: "fit-content" }}>
        ...
        <div className="grid grid-cols-2 mt-2">
          <div>
          <Select
              label={<LabelWithAsterisk name="Lawyer Type" />} // Assuming LabelWithAsterisk is defined and imported correctly
              options={options}
...
<Input
              labelClass="text-[18px] text-[#050505] font-[400]"
              inputType="text"
              label={<LabelWithAsterisk name="First Name" />}
...
<Input
              labelClass="text-[18px] text-[#050505] font-[400]"
              inputType="text"
              label={<LabelWithAsterisk name="Middle Name" />}
              contClass="flex items-center px-6 py-2 justify-between"
              // placeholder="DD/MM/YYYY"
              inputClass="bg-red-400 w-3/5 text-[#AAAAAA] text-[14px]  h-5 p-1 border-[#AAAAAA] border-b-[0.5px]"
            />
            ...
            <Select
              label={<LabelWithAsterisk name="Email" />} // Assuming LabelWithAsterisk is defined and imported correctly
              options={options}
              contClass="flex items-center justify-between px-6 py-3 "
              labelClass="text-[18px] text-[#050505] font-[400]"
              optionClassName="bg-transparent w-3/5 text-[#AAAAAA] text-[14px] h-5 p-1 border-[#AAAAAA] border-b-[0.5px]"
            ...
            <Select
              label={<LabelWithAsterisk name="Address" />} // Assuming LabelWithAsterisk is defined and imported correctly
              options={options}
              contClass="flex items-center justify-between px-6 py-3 "
              labelClass="text-[18px] text-[#050505] font-[400]"
              optionClassName="bg-transparent w-3/5 text-[#AAAAAA] text-[14px] h-5 p-1 border-[#AAAAAA] border-b-[0.5px]"
            ...
            <Input
              labelClass="text-[18px] text-[#050505] font-[400]"
              inputType="text"
              label={<LabelWithAsterisk name="City" />}
              contClass="flex items-center px-6 py-2 justify-between"
              // placeholder="DD/MM/YYYY"
              inputClass="bg-red-400 w-3/5 text-[#AAAAAA] text-[14px]  h-5 p-1 border-[#AAAAAA] border-b-[0.5px]"
            />
            <Input
              labelClass="text-[18px] text-[#050505] font-[400]"
              inputType="text"
              label={<LabelWithAsterisk name="State" />}
              contClass="flex items-center px-6 py-2 justify-between"
              // placeholder="DD/MM/YYYY"
              inputClass="bg-red-400 w-3/5 text-[#AAAAAA] text-[14px]  h-5 p-1 border-[#AAAAAA] border-b-[0.5px]"
            />
            <Input
              labelClass="text-[18px] text-[#050505] font-[400]"
              inputType="text"
              label={<LabelWithAsterisk name="Country" />}
              contClass="flex items-center px-6 py-2 justify-between"
              // placeholder="DD/MM/YYYY"
              inputClass="bg-red-400 w-3/5 text-[#AAAAAA] text-[14px]  h-5 p-1 border-[#AAAAAA] border-b-[0.5px]"
            />
          ...
          <div className="">
          <Select
                label="Gender" // Assuming LabelWithAsterisk is defined and imported correctly
                options={options}
                contClass="flex items-center justify-between px-6 py-3 "
                labelClass="text-[18px] text-[#050505] font-[400]"
          ...
          <Input
              labelClass="text-[18px] text-[#050505] font-[400]"
              inputType="text"
              label={<LabelWithAsterisk name="Last Name" />}
              contClass="flex items-center px-6 py-2 justify-between"
              // placeholder="DD/MM/YYYY"
              inputClass="bg-red-400 w-3/5 text-[#AAAAAA] text-[14px]  h-5 p-1 border-[#AAAAAA] border-b-[0.5px]"
            />
            <Input
              labelClass="text-[18px] text-[#050505] font-[400]"
              inputType="text"
              label={<LabelWithAsterisk name="Mobile Number" />}
              contClass="flex items-center px-6 py-2 justify-between"
              // placeholder="DD/MM/YYYY"
              inputClass="bg-red-400 w-3/5 text-[#AAAAAA] text-[14px]  h-5 p-1 border-[#AAAAAA] border-b-[0.5px]"
            />
             <Input
              labelClass="text-[18px] text-[#050505] font-[400]"
              inputType="text"
              label={<LabelWithAsterisk name="Alternate Number" />}
              contClass="flex items-center px-6 py-2 justify-between"
              // placeholder="DD/MM/YYYY"
              inputClass="bg-red-400 w-3/5 text-[#AAAAAA] text-[14px]  h-5 p-1 border-[#AAAAAA] border-b-[0.5px]"
            />
              ...
              labelClass="text-[18px] text-[#050505] font-[400]"
              inputType="date"
              label={<LabelWithAsterisk name="Date of Birth" />}
...
<Input
              labelClass="text-[18px] text-[#050505] font-[400]"
              inputType="text"
              label={<LabelWithAsterisk name="Age " />}
              contClass="flex items-center px-6 py-2 justify-between"
              // placeholder="DD/MM/YYYY"
              inputClass="bg-red-400 w-3/5 text-[#AAAAAA] text-[14px]  h-5 p-1 border-[#AAAAAA] border-b-[0.5px]"
            />
            ...
            <Input
              ...
              contClass="flex items-center px-6 py-4 justify-between"
              // placeholder="DD/MM/YYYY"
              inputClass="bg-red-400 w-3/5 text-[#AAAAAA] text-[14px]  h-2 p-1 "
            />
              <Select
                label="Rating" // Assuming LabelWithAsterisk is defined and imported correctly
                options={options}
                contClass="flex items-center justify-between px-6 py-3 "
                labelClass="text-[18px] text-[#050505] font-[400]"
                optionClassName="bg-transparent w-3/5 text-[#AAAAAA] text-[14px] uppercase h-0 p-2 border-[#AAAAAA] border-b-[0.5px]"
        ...
        <div className="buttons flex items-center justify-center gap-10  mt-[15px] ">
          <Button
            label="Submit"
            btnType="submit"
